...
public class XHRCapture {
	...
	public void setUp() throws Exception {
		...
		/*
		 * Check whether it can find username/password element to see if it's
		 * already logged -> Better way will be to check against the website
		 * title -> or some other in-built method
		 */
		try {
			...
			loggedIn = true;
			System.out.println("Already logged in to the website");
			Thread.sleep(10000);
	...
	public void tearDown() {
		...
		//Write har content to JSON file using GSON
